...
<div class="container px-md-5 pb-5">
    <div class="text-center">
        <br>
        <h2 class="index-header text-danger">{{ $project->name }}</h2>
        <br>
    </div>
    ...
    <div class="row justify-content-center">
        ...
        <div class="row justify-content-center my-4">
            <div class="col-md-10">
                <img src="{{  $item->photos[0]  }}" class="img-fluid border border-dark" />
            </div>
        </div>
        ...
        <div class="row justify-content-center my-4" key={index}>
            ...
            <div class="col-md-6 mt-4 mt-md-0">
                <img src="{{  $item->photos[1]  }}" class="img-fluid border border-dark" />
            </div>
        </div>
        ...
        <div class="row justify-content-center mb-md-4 mt-1">
            <div class="col-md-6">
                <img src="{{  $item->photos[2]  }}" class="img-fluid border border-dark" />
            </div>
            <div class="col-md-6 mt-4 mt-md-0">
                <img src="{{  $item->photos[3]  }}" class="img-fluid border border-dark" />
            </div>
        </div>
        @endif
    </div>
